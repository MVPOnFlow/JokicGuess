...
const JOKIC_SEASON_DATA = {
    ...
    playoffs: [
      ...
      },
      {
        ...
        games: [
          ...
          { game: 2, date: '2023-05-03', result: 'W', denScore: 108, oppScore: 97,  ot: false, pts: 17, reb: 9,  ast: 2, stl: 0, blk: 1, min: 34 },
          { game: 3, date: '2023-05-05', result: 'L', denScore: 114, oppScore: 121, ot: false, pts: 29, reb: 13, ast: 12, stl: 1, blk: 0, min: 40 },
          { game: 4, date: '2023-05-07', result: 'L', denScore: 124, oppScore: 129, ot: false, pts: 53, reb: 14, ast: 3, stl: 2, blk: 0, min: 44 },
          { game: 5, date: '2023-05-09', result: 'W', denScore: 118, oppScore: 109, ot: false, pts: 29, reb: 14, ast: 4, stl: 0, blk: 1, min: 40 },
  ...
  '2024-25': {
    ...
    conference: 'West',
    awards: [],
    /* Nuggets beat Clippers 4-3 R1, lost to OKC 3-4 R2 */
    playoffs: [
      {
        round: 'R1',
        ...
        seriesScore: '4-3',
        games: [
          { game: 1, date: '2025-04-20', result: 'W', denScore: 112, oppScore: 104, ot: false, pts: 33, reb: 14, ast: 9, stl: 2, blk: 1, min: 40 },
          { game: 2, date: '2025-04-23', result: 'L', denScore: 98,  oppScore: 110, ot: false, pts: 24, reb: 10, ast: 7, stl: 0, blk: 0, min: 37 },
          { game: 3, date: '2025-04-26', result: 'W', denScore: 118, oppScore: 105, ot: false, pts: 36, reb: 12, ast: 11, stl: 1, blk: 0, min: 42 },
          { game: 4, date: '2025-04-28', result: 'L', denScore: 101, oppScore: 108, ot: false, pts: 27, reb: 11, ast: 8, stl: 1, blk: 0, min: 38 },
          { game: 5, date: '2025-05-01', result: 'W', denScore: 115, oppScore: 109, ot: false, pts: 35, reb: 13, ast: 10, stl: 2, blk: 1, min: 41 },
          { game: 6, date: '2025-05-03', result: 'L', denScore: 104, oppScore: 111, ot: false, pts: 28, reb: 9,  ast: 6, stl: 1, blk: 0, min: 39 },
          { game: 7, date: '2025-05-05', result: 'W', denScore: 120, oppScore: 110, ot: false, pts: 38, reb: 15, ast: 12, stl: 2, blk: 0, min: 43 },
        ],
      },
      {
        round: 'R2',
        ...
        seriesScore: '3-4',
        games: [
          { game: 1, date: '2025-05-08', result: 'W', denScore: 110, oppScore: 105, ot: false, pts: 34, reb: 14, ast: 10, stl: 1, blk: 1, min: 42 },
          { game: 2, date: '2025-05-10', result: 'L', denScore: 100, oppScore: 112, ot: false, pts: 26, reb: 10, ast: 8, stl: 0, blk: 0, min: 38 },
          { game: 3, date: '2025-05-13', result: 'W', denScore: 114, oppScore: 108, ot: false, pts: 37, reb: 13, ast: 9, stl: 2, blk: 1, min: 43 },
          { game: 4, date: '2025-05-15', result: 'L', denScore: 96,  oppScore: 106, ot: false, pts: 22, reb: 11, ast: 7, stl: 1, blk: 0, min: 37 },
          { game: 5, date: '2025-05-18', result: 'W', denScore: 118, oppScore: 113, ot: true,  pts: 40, reb: 14, ast: 11, stl: 2, blk: 0, min: 46 },
          { game: 6, date: '2025-05-20', result: 'L', denScore: 102, oppScore: 110, ot: false, pts: 30, reb: 12, ast: 6, stl: 1, blk: 0, min: 41 },
          { game: 7, date: '2025-05-22', result: 'L', denScore: 98,  oppScore: 106, ot: false, pts: 32, reb: 14, ast: 8, stl: 0, blk: 0, min: 42 },
        ],
      },
    ],
  },
