...
from utils.helpers import (
    ...
    create_predictions_csv, count_total_predictions, is_admin,
    custom_reward, get_basic_pet_response, extract_fastbreak_runs,
    pull_rankings_for_fb, map_wallet_to_username, save_gift,
...
def register_commands(bot, conn, cursor, db_type):
    """Register all Discord bot slash commands."""
